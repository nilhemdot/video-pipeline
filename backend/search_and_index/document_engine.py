...
def process_file(file_path):
    ...
    media_id = save_doc_to_db(
        file_path, file_name, segments, source_type="note", summary=summary_text
    )

    if media_id:
        save_to_vector_db(
            media_id, file_name, file_path, segments, summary=summary_text
        )
...
def process_pdf(file_path):
    ...
    summary_text = summary_generator(segments)
    media_id = save_doc_to_db(
        file_path, file_name, segments, source_type="pdf", summary=summary_text
    )
